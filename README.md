...
│   └── sync-skills-to-codex.sh  # Sync/check/prune Claude skills in Codex
...
- Runtime baseline link: `~/.claude/settings.base.json`
...
claude-code/scripts/sync-skills-to-codex.sh --check

# Apply sync and prune stale managed skills
claude-code/scripts/sync-skills-to-codex.sh --prune
```
