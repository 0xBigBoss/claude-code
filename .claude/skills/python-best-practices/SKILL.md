...
description: Python code quality patterns for error handling, exception propagation, and debug logging. Use when writing, reviewing, or debugging Python code.
---
