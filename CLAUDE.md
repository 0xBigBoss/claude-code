...
**IMPORTANT**: Prefer Peekaboo CLI analysis instead of directly reading the image files to preserve your context and token usage unless it is absolutely necessary to read the image file directly. This optimization prevents token exhaustion on large images.
...
1. **Privacy**: Be mindful of sensitive information in screenshots. Peekaboo captures exactly what's visible.
2. **AI Prompts**: Be specific in analysis prompts for better results. Vague prompts yield vague results.
3. **Performance**: Local AI models (Ollama) provide privacy but may be slower than cloud models.
